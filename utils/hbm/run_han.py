...
def import_data(dataset):
    ...
    df_neg_text = pd.read_csv(os.path.join(args['text_data_dir'],'%s/%s_neg_text.csv'%(dataset,"Longer_MovieReview")))
    df_pos_text = pd.read_csv(os.path.join(args['text_data_dir'],'%s/%s_pos_text.csv'%(dataset,"Longer_MovieReview")))
