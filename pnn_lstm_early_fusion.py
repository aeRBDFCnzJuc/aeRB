...
parser.add_argument('--output_dnn_num', type=int, default=2)
...
# ## Train
from models.wdl_lstm_layers import PNNDeepEF

config = copy.deepcopy(args)
config.dnn_hidden_units = raw_dense_list[-args.output_dnn_num:]

model_map = {"WideDeepEF":PNNDeepEF}
WideDeep = model_map[args.wdl_mode]
