...
# data
def load_data_loader(args,add_config=True):
    # wide
    data_dir = "data/dataset/"
    fname = "df_feature_num_label-3.csv"
    ...
    x_train, y_train, x_dev, y_dev, x_test, y_test = load_save_vectors(
        'data/features/lstm_only_text/{}'.format(args.emb_name))
...
def train_model(data,model,args,device):
    ...
    for epoch in range(args.epochs):
        ...
        for data in train_loader:
            ...
            loss_func = nn.CrossEntropyLoss(weight, reduction='mean')
